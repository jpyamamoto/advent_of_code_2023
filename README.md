...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `113.5µs` | `1.1ms` |
| [Day 2](./src/bin/02.rs) | `101.2µs` | `101.8µs` |
| [Day 3](./src/bin/03.rs) | `105.7µs` | `99.8µs` |
| [Day 4](./src/bin/04.rs) | `254.3µs` | `262.2µs` |
| [Day 5](./src/bin/05.rs) | `46.4µs`  | `46.3s` |
